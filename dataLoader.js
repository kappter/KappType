...
export function populateVocabDropdown(vocabSelect, amalgamateSelect) {
  ...
  const vocabSets = [
    ...
    { name: 'Game Development Fundamentals 1', url: '/vocab-sets/Game_Development_Fundamentals_1_Terms_Definitions.csv' },
    { name: 'Game Development Fundamentals 2', url: '/vocab-sets/Game_Development_Fundamentals_2_Terms_Definitions.csv' },
    ...
    { name: 'Music Theory', url: '/vocab-sets/Music_Theory_Terms_Definitions.csv' },
    ...
    { name: 'Summer Job Preparation', url: '/vocab-sets/Summer_Job_Preparation_Terms_Definitions.csv' },
    { name: 'Utah Computer Programming 1', url: '/vocab-sets/Utah_Computer_Programming_1_Terms_Definitions.csv' },
    { name: 'Web Development', url: '/vocab-sets/Web_Development_Terms_Definitions.csv' },
